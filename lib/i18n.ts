...
export const T = {
  ...
  open:      { en: 'Open',    fr: 'Ouvert', rw: 'Ikizamini kirakinguye' },
  closed:    { en: 'Closed',  fr: 'Fermé',  rw: 'Ikizamini kirafunze'  },
  ...
  inProgress:   { en: 'In Progress',      fr: 'En cours',              rw: 'Muri gahunda'       },
  takeExam:     { en: 'Take Exam',        fr: 'Passer l\'Examen',      rw: 'Kora ikizamini'     },
  continueExam: { en: 'Continue',         fr: 'Continuer',             rw: 'Komeza'             },
