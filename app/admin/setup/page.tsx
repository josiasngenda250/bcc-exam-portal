...
export default async function AdminSetupPage({
  ...
  const errors: Record<string, string> = {
    ...
    failed:   'Something went wrong — check that FIREBASE_SERVICE_ACCOUNT_KEY is set on Vercel.',
  };
    ...
    <div style={{ minHeight: '100vh', background: 'var(--bcc-navy)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16 }}>
      <div style={{ background: 'white', borderRadius: 16, padding: 40, width: '100%', maxWidth: 440, boxShadow: '0 8px 32px rgba(0,0,0,0.3)' }}>
        <div className="text-center mb-8">
          <img src="/bcc-logo.png" alt="BCC" style={{ height: 72, width: 72, objectFit: 'contain', margin: '0 auto 16px' }} />
        ...
        <form action="/api/admin/setup" method="POST">
          ...
          <input id="name" name="name" type="text" className="input-field mb-4"
            placeholder="Josias Ngenda" autoFocus required />
          ...
          <input id="password" name="password" type="password" className="input-field mb-4"
            placeholder="At least 8 characters" required />

          <label className="block font-bold mb-1" htmlFor="confirm">Confirm Password</label>
          <input id="confirm" name="confirm" type="password" className="input-field mb-6"
